...
import Pipeline from "@/enums/Pipeline";
import Scene from "@/enums/Scene";
import TextQueue from "@/properties/TextQueue";
...
export default class MainScene extends Phaser.Scene {
    ...
    private addText(): void {
        this.text = this.add
            .dynamicBitmapText(GAME_WIDTH * 1.5, GAME_HEIGHT / 2, Asset.ATARI_SMOOTH)
            .setText("")
            .setFontSize(30)
            .setOrigin(0.5, 0.5)
            .setCenterAlign();
    ...
    private addShiba(): void {
        ...
        this.add
            .sprite(GAME_WIDTH / 2, GAME_HEIGHT - 64, Asset.SHIBA)
    ...
    private addBackground(): void {
        ...
        this.backgroundForeground = this.addScaledBackground(Asset.FOREGROUND, 352, 192).setY(GAME_HEIGHT / 40);
    }

    private addScaledBackground(
        asset: string,
        textureWidth: number,
        ...
        return this.add.tileSprite(0, 0, GAME_WIDTH, GAME_HEIGHT, asset).setScale(scaled).setOrigin(0.0, 0.0);
    }
    */
}
